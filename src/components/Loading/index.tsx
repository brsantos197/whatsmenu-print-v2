...
export const Loading = () => {
  return (
    <SafeAreaView className='z-10 absolute inset-0 top-6 h-screen w-screen backdrop-opacity-50 items-center justify-items-end dark:bg-zinc-50/40 light:bg-zinc-950/40'>
